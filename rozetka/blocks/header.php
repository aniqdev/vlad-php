  ...
  <body>
    <div class="header">
      <div class="top-banner">
        <img src="images/top-banner.jpg" alt="" title="Модный взрыв" />
      </div>
      <div class="top-console">
        ...
        <div class="premium-btn">
          ...
          <svg viewBox="0 0 96 32" id="icon-premium">
            <path
              d="m2.61711 0c-1.696112 5.01428-2.61711 10.3973-2.61711 16s.920998 10.9857 2.61711 16h90.76579c1.6961-5.0143 2.6171-10.3973 2.6171-16s-.921-10.98572-2.6171-16z"
              fill="#471a7b"
            ></path>
            <g fill="#f7d869">
              <path
                d="m14.9764 10h-3.9764v11.7978h1.6244v-4.7191h2.2674c2.7073 0 4.1287-1.4832 4.1287-3.5394s-1.3876-3.5393-4.0441-3.5393zm.1861 5.7472h-2.5381v-4.4157h2.5381c1.3198 0 2.1997.8764 2.1997 2.2078 0 1.3315-.8799 2.2079-2.1997 2.2079z"
              ></path>
              <path
                d="m28.022 21.7978h2.2336l-4.5517-5.2248c1.8782-.3876 2.8427-1.6179 2.8427-3.2191 0-1.955-1.3875-3.3539-4.0441-3.3539h-3.621v11.7978h1.6244v-5.1068h1.269zm-5.5161-10.4832h2.2166c1.3198 0 2.1658.7921 2.1658 2.0562 0 1.2472-.846 2.0562-2.1658 2.0562h-2.2166z"
              ></path>
              <path
                d="m39.0508 11.4157v-1.4157h-7.4451v11.7978h7.4451v-1.4158h-5.8207v-3.9438h4.9747v-1.4157h-4.9747v-3.6068z"
              ></path>
              <path
                d="m51.6665 10-4.4502 7.5169-4.4502-7.5169h-1.6921v11.7978h1.6244v-9.1012l4.4671 7.5843 4.4671-7.5843v9.1012h1.6244v-11.7978z"
              ></path>
              <path d="m56.047 21.7978h1.6243v-11.7978h-1.6243z"></path>
              <path
                d="m65.2794 22c2.978 0 4.907-1.8371 4.907-4.7528v-7.2472h-1.6244v7.3315c0 1.8539-1.2691 3.2191-3.2826 3.2191-2.0136 0-3.2827-1.3652-3.2827-3.2191v-7.3315h-1.6244v7.2472c0 2.9157 1.929 4.7528 4.9071 4.7528z"
              ></path>
              <path
                d="m83.4094 10-4.4501 7.5169-4.4502-7.5169h-1.6921v11.7978h1.6244v-9.1012l4.4671 7.5843 4.4671-7.5843v9.1012h1.6244v-11.7978z"
              ></path>
            </g>
          </svg>
        </div>
